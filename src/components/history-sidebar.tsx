...
import { LayoutDashboard, MessageSquare, PanelLeftClose, PanelLeftOpen, Plus, Trash2 } from 'lucide-react';

import { Button } from '@/components/ui/button';
import { deleteChatThread, getChatThreads, supabase, type ChatThread } from '@/lib/supabase';
...
export function HistorySidebar({ userId, currentThreadId, isOpen, setIsOpen }: HistorySidebarProps) {
