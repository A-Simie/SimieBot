...
export default async function DashboardPage() {
  ...
  const EmptyState = (
    <div className="flex h-full min-w-0 flex-col items-center justify-start px-2 py-6 text-center sm:justify-center sm:px-4 sm:py-12">
      <div className="flex w-full max-w-full items-center justify-center sm:block">
        <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-[8px] font-bold uppercase tracking-[0.14em] text-secondary sm:px-4 sm:text-[10px] sm:tracking-[0.26em]">
          <span className="h-2 w-2 shrink-0 rounded-full bg-secondary shadow-[0_0_16px_rgba(0,227,253,0.8)]" />
          <span className="truncate">Secure actions across connected accounts</span>
        </div>
      </div>
      ...
      <div className="mt-6 grid w-full max-w-full min-w-0 gap-3 sm:mt-8 sm:max-w-4xl sm:grid-cols-2 xl:grid-cols-3">
        <div className="min-w-0 rounded-[1.35rem] border border-white/8 bg-white/4 p-4 text-left shadow-[0_24px_60px_rgba(0,0,0,0.25)] sm:rounded-3xl">
  ...
  return (
    <div className="relative min-h-[calc(100dvh-3.5rem)] overflow-x-hidden bg-[radial-gradient(circle_at_top,rgba(134,173,255,0.16),transparent_32%),radial-gradient(circle_at_20%_80%,rgba(0,227,253,0.08),transparent_24%),linear-gradient(180deg,#0a0e14_0%,#0b1016_100%)]">
      <div className="mx-auto flex min-h-[calc(100dvh-3.5rem)] w-full max-w-6xl min-w-0 flex-col px-2 pb-3 pt-3 sm:px-6 sm:pb-6 sm:pt-6 lg:px-8">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
          <div className="min-w-0">
            <p className="text-[10px] font-bold uppercase tracking-[0.28em] text-secondary">Operator session</p>
            <h2 className="mt-2 font-headline text-lg font-black tracking-tight text-on-surface sm:text-3xl">
          ...
          <div className="w-full shrink-0 rounded-[1.35rem] border border-white/10 bg-white/5 px-4 py-3 text-left shadow-[0_20px_50px_rgba(0,0,0,0.28)] sm:w-fit sm:rounded-3xl sm:text-right">
        ...
        <div className="flex-1 min-w-0 overflow-hidden rounded-[1.1rem] border border-white/8 bg-white/[0.03] shadow-[0_30px_90px_rgba(0,0,0,0.32)] backdrop-blur-xl sm:rounded-[2rem]">
          <ChatWindow
